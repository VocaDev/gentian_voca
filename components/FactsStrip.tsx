export function FactsStrip({
  ...
  return (
    <dl className={`m-0 grid grid-cols-2 gap-px border border-hairline bg-hairline ${cols}`}>
      {facts.map((f) => (
        <div key={f.label} className="flex flex-col-reverse gap-1 bg-paper p-4 md:p-5">
